<footer>
  <div class="molecule liquid">
    ...
    <ul id="social-media">
      <li><a href="https://www.youtube.com/channel/UCsaurqTzPbEaKiO5JnhezEA" target="_blank"><img src="<?php echo get_theme_file_uri('images/social-youtube.svg')?>" /></a></li>
      <li><a href="https://www.instagram.com/khralenok.studio/" target="_blank"><img src="<?php echo get_theme_file_uri('images/social-instagram.svg')?>" /></a></li>
      <li><a href="https://www.linkedin.com/in/khralenok/" target="_blank"><img src="<?php echo get_theme_file_uri('images/social-linkedin.svg')?>" /></a></li>
    </ul>
  </div>
  <div class="molecule liquid">
